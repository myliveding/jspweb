...
public class MessageUtil {
     ...
     * 返回消息类型：文本
     */
    static final String RESP_MESSAGE_TYPE_TEXT = "text";

    /**
     * 返回消息类型：音乐
     */
    static final String RESP_MESSAGE_TYPE_MUSIC = "music";

    /**
     * 返回消息类型：图文
     */
    static final String RESP_MESSAGE_TYPE_NEWS = "news";

    static final String RESP_MESSAGE_TYPE_IMAGE = "image";

    /**
     * 请求消息类型：文本
     */
    static final String REQ_MESSAGE_TYPE_TEXT = "text";

    /**
     * 请求消息类型：图片
     */
    static final String REQ_MESSAGE_TYPE_IMAGE = "image";
     ...
     * 请求消息类型：地理位置
     */
    static final String REQ_MESSAGE_TYPE_LOCATION = "location";

    /**
     * 请求消息类型：音频
     */
    static final String REQ_MESSAGE_TYPE_VOICE = "voice";

    /**
     * 请求消息类型：推送
     */
    static final String REQ_MESSAGE_TYPE_EVENT = "event";

    /**
     * 事件类型：subscribe(订阅)
     */
    static final String EVENT_TYPE_SUBSCRIBE = "subscribe";

    /**
     * 事件类型：unsubscribe(取消订阅)
     */
    static final String EVENT_TYPE_UNSUBSCRIBE = "unsubscribe";
    /**
     * 事件类型：SCAN(扫码)
     */
    static final String EVENT_TYPE_SCAN = "SCAN";
...
//                  }  
     ...
     * @return xml
     */
    static String newsMessageToXml(NewsMessage newsMessage) {
